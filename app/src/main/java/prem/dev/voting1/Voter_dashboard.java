...
ImageView one,two,three,four,five;
    ...
    DatabaseReference vreference,vote,ViewResult;
    FirebaseAuth cauth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vreference = FirebaseDatabase.getInstance().getReference("Users").child(Uid);
        ...
        one = findViewById(R.id.vp);
        two = findViewById(R.id.vc);

        four = findViewById(R.id.vv);
        five = findViewById(R.id.vr);
...
//             User user = snapshot.getValue(User.class);
                ...
                String nam = (String) snapshot.child("isEnabled").getValue().toString();
    ...
    /*    ViewResult.addValueEventListener(new ValueEventListener() {
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent vp = new Intent(Voter_dashboard.this, Dashboard.class);
                startActivity(vp);
            }
        });
        ...
        two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vc = new Intent(Voter_dashboard.this, VoterCandidate_ListActivity.class);
                startActivity(vc);
            }
        });
        four.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vv = new Intent(Voter_dashboard.this, vVote.class);
                startActivity(vv);
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vv = new Intent(Voter_dashboard.this, vResult.class);
                startActivity(vv);
            }
        });
    }
